...
class TestInterfaceDetection:
    ...
    def detector(self):
        ...
        def detect_interface(name: str, labels: dict) -> str:
            ...
            if (
                ...
                or ("_" in name and name.endswith(("_1", "_2", "_3")))
            ):
                return INTERFACE_OTHER
    ...
    def test_explicit_orchestration_label(self, detector):
        ...
        result = detector(name="my-project._.1001", labels={"ds01.interface": "orchestration"})
    ...
    def test_ds01_managed_label(self, detector):
        ...
        result = detector(name="custom-container", labels={"ds01.managed": "true"})
        assert result == "atomic"
    ...
    def test_aime_naming_pattern(self, detector):
        ...
        result = detector(name="project-a._.1001", labels={})
        assert result == "atomic"

    @pytest.mark.unit
    def test_aime_naming_with_complex_name(self, detector):
        """Complex AIME names detected correctly."""
        result = detector(name="my-awesome-project._.65534", labels={})
        assert result == "atomic"
    ...
    def test_vscode_prefix(self, detector):
        ...
        result = detector(name="vscode-my-project-abc123", labels={})
        assert result == "other"

    @pytest.mark.unit
    def test_devcontainer_label(self, detector):
        """Container with devcontainer label detected as Other."""
        result = detector(name="random-name", labels={"devcontainer": "true"})
        assert result == "other"
    ...
    def test_devcontainer_metadata_label(self, detector):
        ...
        result = detector(
            name="random-name", labels={"devcontainer.metadata": '{"some": "config"}'}
        )
        assert result == "other"
    ...
    def test_plain_docker_container(self, detector):
        ...
        result = detector(name="my-container", labels={})
    ...
    def test_docker_with_random_labels(self, detector):
        ...
        result = detector(
            name="custom-app", labels={"maintainer": "someone@example.com", "version": "1.0"}
        )
        assert result == "docker"
    ...
    def test_explicit_label_overrides_naming(self, detector):
        ...
        result = detector(name="project._.1001", labels={"ds01.interface": "orchestration"})
        assert result == "orchestration"
    ...
    def test_ds01_managed_overrides_tool_detection(self, detector):
        ...
        result = detector(name="jupyterhub-something", labels={"ds01.managed": "true"})
        assert result == "atomic"
    ...
    def test_explicit_label_overrides_everything(self, detector):
        ...
        result = detector(
            ...
            labels={"ds01.interface": "orchestration", "com.docker.compose.project": "myproject"},
        )
        assert result == "orchestration"
