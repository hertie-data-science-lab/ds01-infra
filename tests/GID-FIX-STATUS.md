...
- `tests/quick-test-gid-fix.sh` - Uses `container-create` instead of `mlc-create -s`
- `tests/test-gid-fix.sh` - Uses `container-create` instead of `mlc-create -s`
...
- Full technical details: `/opt/ds01-infra/tests/GID-MAPPING-FIX.md`
- Quick test: `/opt/ds01-infra/tests/quick-test-gid-fix.sh`
- Comprehensive test: `/opt/ds01-infra/tests/test-gid-fix.sh`
- Diagnostic tool: `/opt/ds01-infra/tests/diagnose-gid-issue.sh`
- Runtime fix: `/opt/ds01-infra/tests/fix-gid-issue.sh`
