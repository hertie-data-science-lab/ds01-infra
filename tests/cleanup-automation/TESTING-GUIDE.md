...
```bash
cd /opt/ds01-infra/tests/cleanup-automation
...
- `tests/cleanup-automation/test-final.sh` - Full automation test suite
- `tests/cleanup-automation/README.md` - Complete testing documentation
- `tests/cleanup-automation/FINDINGS.md` - Known issues and fixes
