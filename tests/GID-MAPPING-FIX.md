...
- `tests/diagnose-gid-issue.sh` - Diagnostic tool
- `tests/fix-gid-issue.sh` - Runtime fix for existing containers
- `tests/quick-test-gid-fix.sh` - Quick validation test
- `tests/test-gid-fix.sh` - Comprehensive test suite
