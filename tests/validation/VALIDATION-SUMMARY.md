...
**Path**: `/opt/ds01-infra/tests/validation/health-check`
...
**Path**: `/opt/ds01-infra/tests/validation/show-discrepancies.sh`

More verbose output for debugging:
```bash
/opt/ds01-infra/tests/validation/show-discrepancies.sh
```
...
if ! /opt/ds01-infra/tests/validation/health-check; then
...
if ! /opt/ds01-infra/tests/validation/health-check > /dev/null 2>&1; then
    echo "Warning: DS01 system has inconsistencies"
    echo "Run: /opt/ds01-infra/tests/validation/show-discrepancies.sh"
fi
```
...
```
/opt/ds01-infra/tests/validation/
