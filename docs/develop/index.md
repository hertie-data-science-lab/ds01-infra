...
:::note
Subsystem reference content currently lives in READMEs next to the code and is
linked from [Subsystem references](./subsystem-references.md). Migrating that
content into full pages here is tracked as follow-up work.
:::
