...
show_welcome() {
    if [ ! -f /workspace/.ds01-session-started ]; then
        ...
        echo ""
        echo -e "\033[1mIDE Workflow:\033[0m"
        echo -e "  1. Connect IDE to server via SSH (VS Code Remote, PyCharm SSH)"
        echo -e "  2. Edit files in /workspace/<project> from your IDE"
        echo -e "  3. Run code in this container or from IDE terminal"
        echo -e "  4. For notebooks: \033[1;32mjlab\033[0m in container, connect IDE to Jupyter URL"
        echo ""
        ...
        echo -e "  \033[1;32mws\033[0m           Go to workspace           \033[1;32malias\033[0m        See all aliases"
        echo ""
