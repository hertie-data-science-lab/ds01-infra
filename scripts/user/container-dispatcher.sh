...
show_usage() {
    ...
    echo "  ${CYAN}container create${NC} my-project pytorch"
    echo "  ${CYAN}container list${NC}"
    echo "  ${CYAN}container run${NC} my-project"
    echo "  ${CYAN}container stop${NC} my-project"
