...
show_usage() {
    ...
    echo -e "  ${GREEN}init${NC}        Create a new data science project"
    echo -e "  ${GREEN}launch${NC}      Launch container for existing project (builds image if needed)"
    echo ""
    echo -e "${BOLD}Examples:${NC}"
    echo -e "  ${CYAN}project init${NC}                  # Interactive project setup"
    echo -e "  ${CYAN}project init${NC} my-thesis        # Create project directly"
    echo -e "  ${CYAN}project launch${NC}                # Select and launch project"
    echo -e "  ${CYAN}project launch${NC} my-thesis      # Launch specific project"
    echo ""
    echo -e "${YELLOW}Tip:${NC} You can also use hyphenated forms: ${CYAN}project-init${NC}, ${CYAN}project-launch${NC}"
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
}
...
if [ ! -f "$SUBCOMMAND_SCRIPT" ]; then
    ...
    echo ""
    echo "Available subcommands: init, launch"
